...
async def process_update(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if step in steps:
        ...
        if val is not None:
            ...
            # Використовуємо лише потрібні ключі для форматування
